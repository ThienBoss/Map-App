...
object ImageUtils {
    fun saveBitmapToFile(context: Context, bitmap: Bitmap, fileName: String) {
        ...
        saveByteToFile(context, byte, fileName)
    }

    private fun saveByteToFile(context: Context, byte: ByteArray, fileName: String) {
    ...
    fun createUniqueImageFile(context: Context): File {
        ...
        var filename = "ThienMap_" + timeStamp + "_"
        var fileDir = context.getExternalFilesDir(Environment.DIRECTORY_PICTURES)
